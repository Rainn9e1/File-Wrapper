...
Wrapper["fileSize"] = function(o, t)
    ...
    if type(o) == "string" then if isfile(o) then return #readfile(o) end o = listfiles(o) elseif o == nil then o = listfiles("") end
    for i, v in next, o do if isfile(v) then t = t + #readfile(v) elseif isfolder(v) then t = t + filesize(listfiles(v), t) end end
    return t
end
